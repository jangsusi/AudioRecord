...
public class LiteActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            findViewById(R.id.button_1).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    float[] output = new float[]{0};    // 15 = 3 * 5, out = x * 5
                    ...
                    tv_output.setText(input[0]+String.valueOf(output[0]));
                }
            });
        ...
        private Interpreter getTfliteInterpreter(String modelPath) {
            try {
                return new Interpreter(loadModelFile(LiteActivity.this, modelPath));
            } catch (Exception e) {
                e.printStackTrace();
            }
            return null;
